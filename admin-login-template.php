...
Plugin URI: https://haqueemon.me/wordpress/plugins/admin-login-template
...
?>
    ...
    <div class="alt-form-wrapper">
        ...
        <div class="alt-form-title">
            ...
            <h5><?php _e('To see all premium features <a href="https://haqueemon.me/wordpress/plugins/admin-login-template-premium" target="_blank">Click Here</a> ', 'admin-login-template'); ?></h5>
        </div>
